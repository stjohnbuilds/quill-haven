# Parked ideas (Marie's, captured 2026-06-21)
...
## Home screen (parked)
- Idea: keep "Quill Haven" + tagline showing on the home screen (where the
  greeting is). Marie said "leave that for now" — greeting stays as is.

## Writing app
- See `docs/WRITING_APP_PLAN.md` — waiting on Marie's detailed Notes/Projects
  navigation plan before the sidebar/tabs are built.
